                ...
                <div id="product-carousel" className="carousel slide" data-ride="carousel">
                    <div className="carousel-inner border">
                        <div className="carousel-item active">
                            <img className="w-100 h-100" src={require("./../img/product-1.jpg")} alt="Image"/>
                        </div>
                        <div className="carousel-item">
                            <img className="w-100 h-100" src={require("./../img/product-2.jpg")} alt="Image"/>
                        </div>
                        <div className="carousel-item">
                            <img className="w-100 h-100" src={require("./../img/product-3.jpg")} alt="Image"/>
                        </div>
                        <div className="carousel-item">
                            <img className="w-100 h-100" src={require("./../img/product-4.jpg")} alt="Image"/>
                        </div>
                    </div>
                        ...
                        <div className="row">
                            <div className="col-md-6">
                                ...
                                <div className="media mb-4">
                                    <img src={require("./../img/user.jpg")} alt="Image" className="img-fluid mr-3 mt-1" style={{ width: 45 }}/>
